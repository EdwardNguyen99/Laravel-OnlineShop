                ...
                <div class="position-center">
                    <form role="form" action="{{URL::to('/save-category-product')}}" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="category_name" class="form-control" id="product_name" placeholder="Product Name">
                        </div>
                        <div class="form-group">
                            <label for="exampleInputPassword1">Product Description</label>
                            <input type="text" name="category_desc" class="form-control" id="product_desc" placeholder="Product Description">
                        </div>
                        <div class="form-group">
